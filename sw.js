const CACHE_NAME = 'domacnost-plus-v0-1-109';
const APP_ASSETS = [
  './',
  './index.html',
  './styles.css',
  ...
  './assets/icons/domacnost-plus-icon-16-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-32-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-120-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-152-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-167-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-180-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-192-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-384-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-512-v0-1-109.png',
  './assets/icons/domacnost-plus-icon-1024-v0-1-109.png',
  './assets/icons/domacnost-plus-maskable-192-v0-1-109.png',
  './assets/icons/domacnost-plus-maskable-512-v0-1-109.png'
];
