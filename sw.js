const CACHE_NAME = 'domacnost-plus-v0-1-174';
const APP_ASSETS = [
  './',
  './index.html',
  './styles.css',
  ...
  './assets/icon-themes/mono-luxe/cameras.png',
  './assets/icon-themes/mono-luxe/contracts.png',
  './assets/icon-themes/mono-luxe/coupons.png',
  './assets/icon-themes/mono-luxe/devices.png',
  './assets/icon-themes/mono-luxe/finance.png',
  './assets/icon-themes/mono-luxe/garage.png',
  './assets/icon-themes/mono-luxe/hdo.png',
  './assets/icon-themes/mono-luxe/home.png',
  './assets/icon-themes/mono-luxe/homecare.png',
  './assets/icon-themes/mono-luxe/more.png',
  './assets/icon-themes/mono-luxe/notes.png',
  './assets/icon-themes/mono-luxe/packages.png',
  './assets/icon-themes/mono-luxe/polishHolidays.png',
  './assets/icon-themes/mono-luxe/settings.png',
  './assets/icon-themes/mono-luxe/shopping.png',
  './assets/icon-themes/mono-luxe/subscriptions.png',
  './assets/icon-themes/mono-luxe/tasks.png',
  './assets/icon-themes/mono-luxe/warranties.png',
  './assets/icon-themes/mono-luxe/waste.png',
  './assets/icon-themes/mono-luxe/weather.png',
